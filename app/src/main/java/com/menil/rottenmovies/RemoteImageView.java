    ...
    protected static void initCache(Context context) {
        ...
        cache = new LruCache<String, Bitmap>(cacheSize) {
            ...
            protected int sizeOf(String key, Bitmap bitmap) {
                Log.d("Remote Image", "The entire cache size is " + (cache.size() / 1024) + "/" + (cache.maxSize() / 1024) + "MB, there are " + cache.putCount() + " items inserted and the size of this bitmap is " + (bitmap.getRowBytes() * bitmap.getHeight() / 1024 / 1024) + "MB (" + key + ")");
...
/*
            View loader = ((View) getParent()).findViewById(R.id.);
            if (loader != null) {
...
*/
    ...
    class BackgroundDecode extends AsyncTask<String, Integer, Object> {
        ...
        protected Object doInBackground(String... params) {
            if (!isCancelled()) {
                ...
                if (!isDefault) {
                    ...
                    b = BitmapFactory.decodeResource(getContext().getResources(), R.drawable.ic_launcher);
                }
        ...
        protected void onPostExecute(Object bitmap) {
            ...
            if (bitmap != null) {
                Log.i("Remote Image", "Bitmap size: " + ((Bitmap) bitmap).getWidth() + "x" + ((Bitmap) bitmap).getHeight());
              ...
              /*  View loader = ((View) getParent()).findViewById(R.id.contentLoader);
                if (loader != null) {
